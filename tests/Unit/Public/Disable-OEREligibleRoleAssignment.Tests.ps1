...
Describe 'Disable-OEREligibleRoleAssignment' {
    ...
    Context 'request construction' {
        BeforeAll {
            ...
            Mock -ModuleName Omnicit.EntraRBAC Invoke-OERArmRequest {
                [PSCustomObject]@{ id='req1'; name='req1'; properties=[PSCustomObject]@{ scope='/subscriptions/s1'; roleDefinitionId='rd1'; principalId='aaaa0000-0000-0000-0000-000000000001'; principalType='User'; requestType='SelfDeactivate'; status='Provisioned'; requestorId='aaaa0000-0000-0000-0000-000000000001'; expandedProperties=[PSCustomObject]@{ principal=[PSCustomObject]@{displayName='Anna'}; roleDefinition=[PSCustomObject]@{displayName='Reader'}; scope=[PSCustomObject]@{displayName='Prod'} } } }
            }
        }
        It 'PUTs a SelfDeactivate roleAssignmentScheduleRequests request with no scheduleInfo or linkedRoleEligibilityScheduleId' {
            Disable-OEREligibleRoleAssignment -Role 'Reader' -PrincipalId 'aaaa0000-0000-0000-0000-000000000001' -Scope '/subscriptions/s1' -Confirm:$false -WarningAction SilentlyContinue
            Should -Invoke -ModuleName Omnicit.EntraRBAC Invoke-OERArmRequest -Times 1 -ParameterFilter {
                ...
                $Body.properties.requestType -eq 'SelfDeactivate' -and
                $Body.properties.principalId -eq 'aaaa0000-0000-0000-0000-000000000001' -and
                -not $Body.properties.ContainsKey('scheduleInfo') -and
                -not $Body.properties.ContainsKey('linkedRoleEligibilityScheduleId')
            }
        }
        ...
        It 'resolves a friendly principal when -User is supplied' {
            Disable-OEREligibleRoleAssignment -Role 'Reader' -User 'anna@contoso.com' -Scope '/subscriptions/s1' -Confirm:$false -WarningAction SilentlyContinue
        ...
        It 'binds principalId, role, and scope from the pipeline' {
            [PSCustomObject]@{ PrincipalId='aaaa0000-0000-0000-0000-000000000001'; RoleDefinitionId='/subscriptions/s1/providers/Microsoft.Authorization/roleDefinitions/rd1'; Scope='/subscriptions/s1' } |
                Disable-OEREligibleRoleAssignment -Confirm:$false -WarningAction SilentlyContinue
            Should -Invoke -ModuleName Omnicit.EntraRBAC Invoke-OERArmRequest -Times 1 -ParameterFilter {
                $Body.properties.principalId -eq 'aaaa0000-0000-0000-0000-000000000001' -and $Body.properties.requestType -eq 'SelfDeactivate'
            }
        }
        It 'honors -WhatIf (no ARM call)' {
            Disable-OEREligibleRoleAssignment -Role 'Reader' -PrincipalId 'aaaa0000-0000-0000-0000-000000000001' -Scope '/subscriptions/s1' -WhatIf
    ...
    Context 'validation' {
        ...
        It 'errors when no principal is supplied' {
            Disable-OEREligibleRoleAssignment -Role 'Reader' -Scope '/subscriptions/s1' -ErrorVariable e -ErrorAction SilentlyContinue
            $e[0].FullyQualifiedErrorId | Should -Match 'NoPrincipal'
        }
        It 'errors when two principals are supplied' {
            Disable-OEREligibleRoleAssignment -Role 'Reader' -User 'a' -Group 'b' -Scope '/subscriptions/s1' -ErrorVariable e -ErrorAction SilentlyContinue
        ...
        It 'errors with InvalidPrincipalId when -PrincipalId is not a GUID' {
            Disable-OEREligibleRoleAssignment -Role 'Reader' -PrincipalId 'anna@contoso.com' -Scope '/subscriptions/s1' -ErrorVariable e -ErrorAction SilentlyContinue -Confirm:$false
    ...
    It 'binds -ResourceGroup from the pipeline by property name' {
        $RgParam = (Get-Command Disable-OEREligibleRoleAssignment).Parameters['ResourceGroup']
    ...
    It 'binds -ResourceName and -ResourceType from the pipeline by property name' {
        foreach ($ParamName in 'ResourceName', 'ResourceType') {
            $Param = (Get-Command Disable-OEREligibleRoleAssignment).Parameters[$ParamName]
    ...
    It 'binds a piped resource-group-shaped object end to end (not just by attribute metadata)' {
        ...
        $Rg | Disable-OEREligibleRoleAssignment -Role 'Reader' -PrincipalId 'aaaa0000-0000-0000-0000-000000000001' -Confirm:$false -WarningAction SilentlyContinue
    ...
    It 'binds a piped resource-shaped object end to end, including -ResourceName and -ResourceType' {
        ...
        Mock -ModuleName Omnicit.EntraRBAC Resolve-OERRoleDefinitionId { '/subscriptions/sub-guid/providers/Microsoft.Authorization/roleDefinitions/rd1' }
        Mock -ModuleName Omnicit.EntraRBAC Invoke-OERArmRequest {
            [PSCustomObject]@{ id = 'req1'; name = 'req1'; properties = [PSCustomObject]@{ scope = '/subscriptions/sub-guid/resourceGroups/rg-net/providers/Microsoft.Storage/storageAccounts/stg1'; roleDefinitionId = 'rd1'; principalId = 'aaaa0000-0000-0000-0000-000000000001'; principalType = 'User'; requestType = 'SelfDeactivate'; status = 'Provisioned'; requestorId = 'aaaa0000-0000-0000-0000-000000000001'; expandedProperties = [PSCustomObject]@{ principal = [PSCustomObject]@{ displayName = 'Anna' }; roleDefinition = [PSCustomObject]@{ displayName = 'Reader' }; scope = [PSCustomObject]@{ displayName = 'stg1' } } } }
        }
        ...
        $Resource | Disable-OEREligibleRoleAssignment -Role 'Reader' -PrincipalId 'aaaa0000-0000-0000-0000-000000000001' -Confirm:$false -WarningAction SilentlyContinue
        Should -Invoke -ModuleName Omnicit.EntraRBAC Resolve-OERScope -Times 1 -ParameterFilter {
    ...
    Context 'resource-level scope forwarding' {
        BeforeAll {
            ...
            Mock -ModuleName Omnicit.EntraRBAC Resolve-OERRoleDefinitionId { '/subscriptions/s1/providers/Microsoft.Authorization/roleDefinitions/rd1' }
            Mock -ModuleName Omnicit.EntraRBAC Invoke-OERArmRequest {
                [PSCustomObject]@{ id='req1'; name='req1'; properties=[PSCustomObject]@{ scope='/subscriptions/s1/resourceGroups/rg1/providers/Microsoft.Storage/storageAccounts/stg1'; roleDefinitionId='rd1'; principalId='11111111-1111-1111-1111-111111111111'; principalType='User'; requestType='SelfDeactivate'; status='Provisioned'; requestorId='11111111-1111-1111-1111-111111111111'; expandedProperties=[PSCustomObject]@{ principal=[PSCustomObject]@{displayName='Test'}; roleDefinition=[PSCustomObject]@{displayName='Reader'}; scope=[PSCustomObject]@{displayName='stg1'} } } }
            }
        }
        It 'forwards -ResourceType/-ResourceName to Resolve-OERScope' {
            Disable-OEREligibleRoleAssignment -Role 'Reader' -PrincipalId '11111111-1111-1111-1111-111111111111' -Subscription 'Prod' -ResourceGroup 'rg1' -ResourceType 'Microsoft.Storage/storageAccounts' -ResourceName 'stg1' -Confirm:$false -WarningAction SilentlyContinue
            Should -Invoke -ModuleName Omnicit.EntraRBAC Resolve-OERScope -Times 1 -ParameterFilter {
    ...
    Context 'principal guard (shared Resolve-OERPrincipalOrId)' {
        ...
        It 'rejects a non-GUID -PrincipalId with InvalidPrincipalId and does not call ARM' {
            $Err = $null
            Disable-OEREligibleRoleAssignment -PrincipalId 'anna@contoso.com' -Role 'Reader' `
        ...
        It 'reports NoPrincipal when no principal is supplied' {
            $Err = $null
            Disable-OEREligibleRoleAssignment -Role 'Reader' `
                -Scope '/subscriptions/s1' `
                -ErrorAction SilentlyContinue -ErrorVariable Err -Confirm:$false
        ...
        It 'reports AmbiguousPrincipal when -User and -Group are both supplied' {
            $Err = $null
            Disable-OEREligibleRoleAssignment -User 'anna@contoso.com' -Group 'Sales Team' -Role 'Reader' `
                -Scope '/subscriptions/s1' `
                -ErrorAction SilentlyContinue -ErrorVariable Err -Confirm:$false
    ...
    Context 'bearer hygiene' {
        It 'scrubs the bearer-hygiene record when the ARM request fails' {
            # Drives the PUT catch in source/Public/Disable-OEREligibleRoleAssignment.ps1 (the
            # roleAssignmentScheduleRequests try inside ShouldProcess). Resolve-OERScope and
            # Resolve-OERRoleDefinitionId are mocked to SUCCEED so the mocked ARM transport failure
            # is what reaches that catch. Invoke-OERArmRequest sends the Authorization: Bearer
            # header itself, so the failed request object is exactly what CLAUDE.md SECURITY rule 6
            # requires Remove-OERErrorRecord -Record $PSItem to strip as the catch's first statement.
            Mock -ModuleName Omnicit.EntraRBAC Initialize-OERAuth { }
            Mock -ModuleName Omnicit.EntraRBAC Resolve-OERScope { '/subscriptions/s1' }
            Mock -ModuleName Omnicit.EntraRBAC Resolve-OERRoleDefinitionId { '/subscriptions/s1/providers/Microsoft.Authorization/roleDefinitions/rd1' }
            Mock -ModuleName Omnicit.EntraRBAC Invoke-OERArmRequest { throw 'transport failure' }
            Mock -ModuleName Omnicit.EntraRBAC Remove-OERErrorRecord { }
            Disable-OEREligibleRoleAssignment -Role 'Reader' -PrincipalId 'aaaa0000-0000-0000-0000-000000000001' `
                -Scope '/subscriptions/s1' -Confirm:$false -WarningAction SilentlyContinue -ErrorAction SilentlyContinue
...
Describe 'Disable-OEREligibleRoleAssignment verbose output' {
    BeforeAll {
        ...
        Mock -ModuleName Omnicit.EntraRBAC Resolve-OERRoleDefinitionId { '/subscriptions/s1/providers/Microsoft.Authorization/roleDefinitions/rd1' }
        Mock -ModuleName Omnicit.EntraRBAC Invoke-OERArmRequest {
            [PSCustomObject]@{ id = 'req1'; name = 'req1'; properties = [PSCustomObject]@{ scope = '/subscriptions/s1'; roleDefinitionId = 'rd1'; principalId = 'p1'; principalType = 'User'; requestType = 'SelfDeactivate'; status = 'Provisioned'; requestorId = 'p1'; expandedProperties = [PSCustomObject]@{ principal = [PSCustomObject]@{ displayName = 'Anna' }; roleDefinition = [PSCustomObject]@{ displayName = 'Reader' }; scope = [PSCustomObject]@{ displayName = 'Prod' } } } }
        }
    }

    It 'reports the resolved scope, role and principal under -Verbose' {
        $Verbose = Disable-OEREligibleRoleAssignment -Role 'Reader' -User 'anna@contoso.com' -Scope '/subscriptions/s1' -Confirm:$false -WarningAction SilentlyContinue -Verbose 4>&1 |
            Where-Object { $_ -is [System.Management.Automation.VerboseRecord] }
        $Text = $Verbose.Message -join "`n"
        $Text | Should -Match '\[Disable-OEREligibleRoleAssignment\] Target scope:'
        $Text | Should -Match "\[Disable-OEREligibleRoleAssignment\] Resolved role 'Reader' to "
        $Text | Should -Match '\[Disable-OEREligibleRoleAssignment\] Resolved principal to '
    }

    It 'emits no verbose output without -Verbose' {
        $Verbose = Disable-OEREligibleRoleAssignment -Role 'Reader' -User 'anna@contoso.com' -Scope '/subscriptions/s1' -Confirm:$false -WarningAction SilentlyContinue 4>&1 |
            Where-Object { $_ -is [System.Management.Automation.VerboseRecord] }
    ...
    It 'does not write a bearer token or a request body to the verbose stream' {
        ...
        $Text = (Disable-OEREligibleRoleAssignment -Role 'Reader' -User 'anna@contoso.com' -Scope '/subscriptions/s1' -Confirm:$false -WarningAction SilentlyContinue -Verbose 4>&1 |
...
Describe 'Disable-OEREligibleRoleAssignment operator-facing principal label' {
    BeforeEach {
        InModuleScope Omnicit.EntraRBAC { $script:_OERAuthState = $null }
        Mock -ModuleName Omnicit.EntraRBAC Initialize-OERAuth { }
        Mock -ModuleName Omnicit.EntraRBAC Resolve-OERScope { '/subscriptions/s1' }
    ...
    It 'names the group the operator typed, not the resolved GUID, in the warning' {
        $Warn = $null
        Disable-OEREligibleRoleAssignment -Role 'Reader' -Scope '/subscriptions/s1' `
    ...
    It 'still reports the resolved GUID under -Verbose so nothing is hidden' {
        $Verbose = Disable-OEREligibleRoleAssignment -Role 'Reader' -Scope '/subscriptions/s1' `
